...
public class ReproTests {
	...
	@Test
	public void yamlProfileNegationMultipleFiles() {
		SpringApplication application = new SpringApplication(Config.class);
		application.setWebEnvironment(false);
		String configName = "--spring.config.name=profilenegation";
		this.context = application.run(configName, "--spring.profiles.active=Z");
		assertVersionProperty(this.context, null, "A", "Z");
	}
